                        ...
                        if ($args[0] === 'help') {
                            ...
                            if (isset($args[1])) {
                                if (intval($args[1]) >= 1 && intval($args[1]) <= 3) {
                                    $help = "Â§9--- Â§6Â§lSmash Hero setup helpÂ§l $args[1]/3Â§9 ---Â§rÂ§f";
                            ...
                            $p->sendMessage("Â§9--- Â§6Â§lSmash Hero setup helpÂ§l 1/3Â§9 ---Â§rÂ§f" . $help1);
                            return;
                        }
                    }
